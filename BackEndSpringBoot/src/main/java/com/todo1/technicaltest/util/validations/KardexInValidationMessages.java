 ...
 * 31/08/2019
 */
public class KardexInValidationMessages {
	...
	public static final String STOCK_NEGATIVO = "Los valores para las entradas de productos deben ser positivos.";
	public static final String SECUENCIAL_NULO = "El valor de secuencia para la entrada no debe ser nulo.";
	public static final String PERSONA_NULL = "Se debe de ingresar la persona a cargo.";
	public static final String ENTRADA_SIN_PRODUCTOS = "Se debe de ingresar al menos un producto en la entrada.";
	public static final String STOCK_INSUFICIENTE = "El valor ingresado en la salida es mayor al stock de los productos.";
